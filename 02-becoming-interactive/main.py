...
def init():
    ...
    window = sdl2.SDL_CreateWindow(b"Lesson 02 - Becoming Interactive", sdl2.SDL_WINDOWPOS_UNDEFINED, sdl2.SDL_WINDOWPOS_UNDEFINED, windowWidth, windowHeight, sdl2.SDL_WINDOW_RESIZABLE | sdl2.SDL_WINDOW_OPENGL)
    if not window:
